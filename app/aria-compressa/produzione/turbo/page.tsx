...
export const metadata: Metadata = {
  title: "Turbocompressori | Air-next",
  description:
    "Turbocompressori centrifughi oil-free per portate elevate. Indicati per grandi impianti dove le portate richieste superano le capacità delle macchine volumetriche.",
  openGraph: {
    title: "Turbocompressori | Air-next",
    description:
      "Turbocompressori centrifughi oil-free per portate elevate. Indicati per grandi impianti dove le portate richieste superano le capacità delle macchine volumetriche.",
