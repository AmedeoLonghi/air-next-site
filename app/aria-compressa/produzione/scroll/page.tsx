...
export const metadata: Metadata = {
  title: "Compressori Scroll | Air-next",
  description:
    "Compressori scroll oil-free per laboratori, medicale e processi con requisiti di purezza elevati. Tecnologia silenziosa a basse taglie, senza gestione del circuito olio.",
  openGraph: {
    title: "Compressori Scroll | Air-next",
    description:
      "Compressori scroll oil-free per laboratori, medicale e processi con requisiti di purezza elevati. Tecnologia silenziosa a basse taglie, senza gestione del circuito olio.",
